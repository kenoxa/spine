...
- run-advise envoy race condition: Phase 2 Batch dispatches envoy in parallel with consultants, but envoy references consultant output paths that don't exist yet. Fix: dispatch envoy after consultants complete, or inline consultant outputs into envoy prompt
