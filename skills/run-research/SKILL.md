...
description: >
  ...
  or problem framing (use do-discuss).
...
4. Suggest: "Paste into [target] Deep Research. When you have results, start `/do-discuss` or `/do-plan` with the findings."

## Anti-Patterns

- Answering the research question instead of compiling a prompt for external AI
- Skipping security redaction before output
- Auto-dispatching do-discuss or do-plan after output (suggest only)
