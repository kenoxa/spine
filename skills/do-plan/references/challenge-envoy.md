...
4. Instruction: "Review this plan from multiple perspectives. Blocking objections require E2+ evidence. Never block without a better alternative. Challenge unverified assumptions that are a few commands from proof."
