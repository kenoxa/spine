...
- Load `use-envoy`. `@envoy`: prompt = problem framing + final inventory + `key_decisions` + explore summary + signals (self-contained). Tier: standard → `.scratch/<session>/discuss-frame-envoy.md`
