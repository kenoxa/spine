...
if [ -n "$fallback_for" ]; then
    _meta_provider="$fallback_for -> Codex Fallback"
    _meta_fallback_note="Note: $fallback_for was unavailable. This response was generated by Codex as fallback."
fi
