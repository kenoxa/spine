...
resolve_tier() {
    ...
    case "$1:$2" in
        ...
        frontier:opencode)
            _tier_model=opencode-go/kimi-k2.7-code
            _tier_fanout="opencode-go/kimi-k2.7-code opencode-go/qwen3.7-max opencode-go/glm-5.1"
            _tier_effort=high ;;
        standard:opencode)
            _tier_model=opencode-go/mimo-v2.5-pro
            _tier_fanout="opencode-go/mimo-v2.5-pro opencode-go/minimax-m3 opencode-go/kimi-k2.7-code"
            _tier_effort=high ;;
        fast:opencode)
            _tier_model=opencode-go/deepseek-v4-flash
            _tier_fanout="opencode-go/deepseek-v4-flash opencode-go/qwen3.7-plus opencode-go/minimax-m2.7"
            _tier_effort=high ;;
