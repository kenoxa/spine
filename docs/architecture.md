...
The envoy dispatches to a different AI provider (Claude, Codex/GPT, Cursor, OpenCode) for an independent perspective. This is not optional diversity --- it is always multi-provider.
