...
| OpenCode | deepseek-v4-flash (Go light work) / minimax-m2.5-free (Free) | mimo-v2.5-pro or kimi-k2.7-code |
...
export SPINE_ENVOY_OPENCODE=opencode-go/kimi-k2.7-code:high
